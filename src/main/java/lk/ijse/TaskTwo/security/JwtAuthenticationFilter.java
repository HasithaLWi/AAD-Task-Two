...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void handleJwtException(HttpServletResponse respond, int code, String massage) throws IOException {
        respond.setStatus(HttpStatus.OK.value());
        respond.setContentType(MediaType.APPLICATION_JSON_VALUE);

        CommonResponse errorResponse = new CommonResponse(code, massage);
        String jsonResponse = objectMapper.writeValueAsString(errorResponse);
        respond.getWriter().write(jsonResponse);
    }
}
